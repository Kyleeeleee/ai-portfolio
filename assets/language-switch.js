(function () {
  ...
  const translations = {
    ...
    "从金融到 AI，一直在跨界探索。": "Exploring at the intersection of finance and AI.",
    "持续用 AI 将业务想法转化为可体验、可验证的产品原型——": "I use AI to turn business ideas into interactive, testable product prototypes—",
    "从 Agent 到 RAG，从 AIGC 到自动化，不断探索技术落地的边界。": "from agents and RAG to generative media and automation, always focused on practical delivery.",
    "查看 Demo": "Explore demos",
    "查看完整作品集": "View full portfolio",
    "AI 产品 MVP": "AI product MVPs",
    "Agent 原型": "Agent prototypes",
    ...
    "确定方向后，我习惯将想法推进为可点击、可演示、可验证的产品原型，通过真实交互呈现业务理解、产品判断与落地路径。": "Once the direction is clear, I turn the idea into an interactive, demonstrable, and testable prototype that makes the business logic, product judgment, and delivery path tangible.",
    "意向岗位": "Target role",
    "AI 产品经理": "AI Product Manager",
    "所在城市": "Location",
    "厦门 / 福建": "Xiamen, Fujian",
    "教育背景": "Education",
    "金融学硕士": "M.S. in Finance",
    ...
    "围绕 RAG、Agent、Prompt、AIGC 工作流设计产品形态，明确用户场景、功能边界、评估指标和迭代路径。": "Designing RAG, agent, prompting, and generative-media workflows with clear user scenarios, product boundaries, evaluation metrics, and iteration paths.",
    ...
    "原型与交付": "Prototyping and delivery",
    "擅长借助 AI Coding 与轻量技术栈，快速搭建可体验 MVP，让需求验证从文档推进到真实 Demo。": "Using AI-assisted coding and lightweight stacks to build working MVPs quickly, moving validation from documents to real demos.",
    ...
    "AI Agent 系统搭建": "Multi-agent system development",
    "自研项目": "Independent project",
    "基于 OpenClaw 与 AI Coding 搭建多 Agent 协作原型，完成 8 个 Agent 的角色定义、提示词设计与流程配置": "Built a multi-agent collaboration prototype with OpenClaw and AI-assisted coding, defining roles, prompts, and workflows for eight agents.",
    ...
    "设计跨 Agent 协作流程，验证从信息抓取、分析整理到内容生成的自动化闭环": "Designed cross-agent workflows covering information retrieval, analysis, synthesis, and content generation.",
    "搭建飞书日报、行业研究简报、公众号选题与初稿生成等自动化工作流，提升内容生产效率": "Built automated workflows for Feishu daily reports, industry briefs, topic selection, and first-draft generation.",
    ...
    "精选项目": "Selected work",
    "精选 4 个可体验 Demo，覆盖金融风控、知识图谱、AI 商品图生成与 Agent 工作流编排，展示不同业务场景下的 AI 产品落地实践。": "Four representative demos spanning financial risk, knowledge graphs, AI product imagery, and agent workflow orchestration.",
    "查看完整作品集（10 个项目）": "View all 10 projects",
    ...
    "AI 产品落地工具箱": "AI product delivery toolkit",
    ...
    "10 个可体验 AI 产品 Demo，覆盖内容生成、知识服务、智能 Agent、业务自动化与数据分析。": "Ten interactive AI product demos spanning content generation, knowledge services, intelligent agents, business automation, and data analysis.",
