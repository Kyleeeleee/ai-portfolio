(function () {
  ...
  const translations = {
    ...
    "借助 Codex、OpenClaw 等 AI Coding 与 Agent 工具，从业务问题出发，进行 AI 应用场景拆解、产品方案设计、原型搭建、工作流验证与迭代优化。": "Using AI coding and agent tools such as Codex and OpenClaw, I work from business problems to scope AI application scenarios, design product solutions, build prototypes, validate workflows, and iterate.",
    ...
    "借助 Codex、OpenClaw 等 AI Coding 与 Agent 工具搭建个人 AI Agent 工作系统原型，设计 10 个 Agent 的角色分工与协作思路": "Using Codex, OpenClaw, and other AI coding and agent tools, I built a personal AI agent work-system prototype and developed role divisions and collaboration concepts for ten agents.",
    ...
    "基于 AI 前台通话分析设计机会追回、业务结果评估与安全试运行闭环。": "Turn AI receptionist call analytics into opportunity recovery, business outcome measurement, and safe rollout loops.",
    "通话分析": "Call analytics",
    "机会追回": "Recovery Queue",
    "能力路线图": "Skill Roadmap",
    ...
    "面向 AI 产品经理岗位的原型验证作品集": "A prototype-validation portfolio for AI product manager roles",
    "每个 Demo 都保留可点击详情页和在线体验入口，重点展示业务场景拆解、AI 能力边界、流程设计与可验证交互。": "Each demo includes a detail page and live experience, highlighting business-scenario breakdown, AI capability boundaries, workflow design, and testable interaction.",
    "在线 Demo": "Live demos",
    "重点方向": "Focus areas",
    ...
    "通话分析 → 业务结果评估 → 机会追回 → 安全试运行": "AI receptionist analytics → business outcome measurement → opportunity recovery → safe experiments",
    "内容增长": "Content growth",
    "内容增长 · AIGC": "Content growth · AIGC",
    "AI 内容增长中台": "AI Content Growth Platform",
    "把品牌 brief、热点机会、达人匹配、脚本生成和投放复盘串成增长闭环。": "Connect brand briefs, trend opportunities, creator matching, script generation, and campaign review into one growth loop.",
    "品牌 brief → 热点机会 → 达人匹配 → 脚本生成 → 投放复盘": "Brand brief → trend opportunity → creator matching → script generation → campaign review",
    "热点机会": "Trend opportunity",
    "达人匹配": "Creator matching",
    "复盘回流": "Review feedback loop",
    "内容营销": "Content marketing",
    "投放复盘": "Campaign review",
    "2.5h": "2.5h",
    "选题周期": "Topic cycle",
    "82%": "82%",
    "匹配命中": "Match accuracy",
    "12min": "12 min",
    "舆情响应": "Sentiment response",
    "企业 RAG": "Enterprise RAG",
    "企业 RAG · Agent Ops": "Enterprise RAG · Agent Ops",
    "企业 RAG 智能体运营台": "Enterprise RAG Agent Ops Console",
    "从知识接入、答案溯源、召回评测到权限拦截，展示企业 RAG 交付闭环。": "Show an enterprise RAG delivery loop across knowledge ingestion, answer traceability, retrieval evaluation, and permission guardrails.",
    "知识接入 → 答案溯源 → 召回评测 → 权限治理 → 运营迭代": "Knowledge ingestion → answer traceability → retrieval evaluation → permission governance → ops iteration",
    "知识治理": "Knowledge governance",
    "评测运营": "Evaluation ops",
    "权限拦截": "Permission guardrail",
    "可溯源": "Traceable",
    ...
    "行业知识图谱决策 Agent": "Industry Knowledge Graph Decision Agent",
    "文本事件抽取 → 图谱推理 → 风险研判 → 可追溯决策报告": "Event extraction → graph reasoning → risk judgment → traceable decision report",
    "事件抽取": "Event extraction",
    "图谱推理": "Graph reasoning",
    "证据报告": "Evidence report",
    "抽取 F1": "Extraction F1",
    "研判时效": "Decision speed",
    "证据引用": "Evidence citations",
    "决策 Agent": "Decision Agent",
    "证据链": "Evidence chain",
    "结果": "Outcome",
    "机会": "Opportunity",
    "能力": "Capability",
    ...
    "队列": " queue",
    "路线图": " roadmap",
    "AI 前台": "AI Receptionist",
    "云通信": "Cloud communications",
    "大模型增强": "LLM enhancement",
    "通话理解": "Call understanding",
    "机会判断": "Opportunity scoring",
    "追回闭环": "Recovery loop",
    "AIGC 视觉": "AIGC visuals",
    "参考图": "Reference image",
    "特征约束": "Feature constraints",
    ...
    "材料建议": "Document request",
    "直播运营": "Live operations",
    "事实配置": "Fact setup",
    "弹幕理解": "Comment understanding",
    "话术生成": "Script generation",
    "语言指令": "Language command",
    "设备同步": "Device sync",
    ...
    "企业 RAG 智能体运营台 · 李林豪": "Enterprise RAG Agent Ops Console · Linhao Li",
    "AI 内容增长中台 · 李林豪": "AI Content Growth Platform · Linhao Li",
    "行业知识图谱决策 Agent · 李林豪": "Industry Knowledge Graph Decision Agent · Linhao Li",
    "私有化知识库 · 答案溯源 · 召回评测 · 权限治理": "Private knowledge base · answer traceability · retrieval evaluation · permission governance",
    "把企业知识问答升级为可交付、可评估、可运营的 RAG 产品": "Turn enterprise knowledge Q&A into a deliverable, measurable, and operable RAG product",
    "旧版知识库问答只证明“能检索、能回答”。新版 demo 进一步模拟企业客户真正关心的交付闭环：资料如何治理、答案为什么可信、权限如何隔离、效果如何评估、上线后如何持续迭代。": "The older knowledge-base demo only proved retrieval and answering. This version simulates what enterprise customers actually care about: data governance, answer trust, permission isolation, quality evaluation, and post-launch iteration.",
    "96%": "96%",
    "答案可溯源": "Traceable answers",
    "1.8%": "1.8%",
    "高风险幻觉率": "High-risk hallucination rate",
    "100%": "100%",
    "权限测试拦截": "Permission-test blocking",
    "统一管理制度文档、项目资料、网页和业务系统字段，并保留版本、权限标签和失效时间": "Manage policies, project materials, web pages, and business-system fields with versions, permission labels, and expiration dates.",
    "展示召回片段、引用来源、置信度、拒答原因和人工复核状态": "Show retrieved chunks, citations, confidence, refusal reasons, and human review status.",
    "把低置信问题、无答案问题和人工改写样本自动沉淀到 RAG 评测集": "Add low-confidence, no-answer, and human-rewritten samples to the RAG evaluation set.",
    "对敏感字段、越权知识和旧版制度执行拦截、脱敏和管理员提醒": "Block, redact, and alert admins for sensitive fields, unauthorized knowledge, and outdated policies.",
    "支持从问答扩展到报告生成、工单草稿和业务系统工具调用": "Extend from Q&A to report drafting, ticket drafts, and business-system tool calls.",
    "知识治理层": "Knowledge governance layer",
    "文档分块、元数据、版本、权限标签和业务域统一入库，避免知识失效和越权调用。": "Ingest chunks, metadata, versions, permission labels, and business domains together to avoid stale or unauthorized knowledge use.",
    "RAG 评测层": "RAG evaluation layer",
    "跟踪召回率、引用准确率、拒答合理性、幻觉率和用户反馈，形成可持续迭代指标。": "Track recall, citation accuracy, refusal quality, hallucination rate, and user feedback as iteration metrics.",
    "Agent 编排层": "Agent orchestration layer",
    "根据意图判断是否需要检索、工具调用、人工确认或转交管理员，保留操作审计。": "Route intent to retrieval, tool calls, human confirmation, or admin handoff while preserving audit logs.",
    "评测闭环": "Evaluation loop",
    "企业 RAG 的产品价值不在“像聊天一样回答”，而在把可信、权限、评测和运营做成闭环。这个版本比旧知识库问答更适合 AI 产品经理投递，因为它体现了从 MVP 到企业交付的产品判断。": "Enterprise RAG value is not answering like a chatbot; it is closing the loop across trust, permissions, evaluation, and operations. This version better demonstrates AI PM judgment from MVP to enterprise delivery.",
    "本 Demo 使用模拟企业资料和权限策略展示产品能力，不包含真实企业敏感数据。": "This demo uses simulated enterprise materials and permission rules. It contains no real sensitive enterprise data.",

    "热点机会 · 达人匹配 · 脚本生成 · 投放复盘": "Trend opportunities · creator matching · script generation · campaign review",
    "把内容运营从经验驱动升级为数据 + 生成 + 复盘闭环": "Upgrade content operations from intuition-led work to a data, generation, and review loop",
    "这个 demo 不把 AIGC 停留在写标题和写脚本，而是覆盖选题机会、达人组合、内容审核、预算调优和舆情响应，适合展示 AI 产品经理对增长业务的理解。": "This demo does not stop at title or script generation. It covers topic opportunities, creator mix, content review, budget tuning, and sentiment response, showing AI PM understanding of growth operations.",
    "选题生产周期": "Topic production cycle",
    "达人匹配命中": "Creator match accuracy",
    "负面评论响应": "Negative-comment response",
    "根据品牌 brief、预算、人群、禁用表达和活动周期生成内容策略": "Generate content strategy from brand brief, budget, audience, banned expressions, and campaign timing.",
    "聚合热点趋势、竞品内容、达人画像和历史投放数据，排序选题机会": "Aggregate trends, competitor content, creator profiles, and historical campaign data to rank topic opportunities.",
    "生成短视频脚本、标题、分镜和评论区回复，并标记合规与品牌调性风险": "Generate short-video scripts, titles, storyboards, and comment replies while flagging compliance and brand-tone risks.",
    "按互动成本、收藏率、转化和评论情绪回流下一轮内容推荐权重": "Feed interaction cost, saves, conversion, and comment sentiment back into the next content recommendation weights.",
    "为运营团队输出达人组合、排期建议、风险词和复盘看板": "Output creator mixes, schedules, risk terms, and review dashboards for operations teams.",
    "策略输入层": "Strategy input layer",
    "结构化品牌目标、预算、客群、平台渠道、合规限制和活动周期。": "Structure brand goals, budget, audience, platform channels, compliance limits, and campaign timing.",
    "AI 生成层": "AI generation layer",
    "热点识别、达人匹配、脚本生成、标题生成和评论回复建议统一进入候选池。": "Send trend detection, creator matching, script generation, title generation, and comment-reply suggestions into one candidate pool.",
    "增长反馈层": "Growth feedback layer",
    "互动、转化、成本、舆情和人工修改记录回流到下一轮策略评分。": "Feed interaction, conversion, cost, sentiment, and human edits back into the next strategy score.",
    "舆情分析": "Sentiment analysis",
    "内容增长类 AI 产品的关键不是生成更多内容，而是让团队知道为什么选这个题、为什么匹配这些达人、投放后如何调整策略。它能补足主页里原本偏客服、风控和工具类 demo 的空白。": "The key to AI content-growth products is not generating more content; it is helping teams understand why a topic was chosen, why creators were matched, and how to adjust after launch. It fills a gap beyond service, risk, and utility demos.",
    "本 Demo 使用模拟营销数据和虚构品牌 brief 展示产品流程，不包含真实投放数据。": "This demo uses simulated marketing data and fictional brand briefs. It contains no real campaign data.",

    "NLP 抽取 · 图谱推理 · 风险研判 · 可追溯报告": "NLP extraction · graph reasoning · risk judgment · traceable reports",
    "把知识图谱从“可视化”升级为可解释的决策 Agent": "Upgrade a knowledge graph from visualization to an explainable decision agent",
    "旧版 demo 重点展示实体关系画布。新版案例把可视化能力放回业务闭环中，进一步覆盖事件抽取、关系推理、风险判断、证据引用、专家复核和持续监控，更适合 AI 产品经理岗位展示。": "The older demo focused on an entity-relation canvas. This version puts visualization back into a business loop covering event extraction, relationship reasoning, risk judgment, evidence citation, expert review, and monitoring.",
    "实体抽取 F1": "Entity extraction F1",
    "8min": "8 min",
    "报告引用覆盖": "Report citation coverage",
    "从公告、新闻、舆情、合同和业务文档中抽取主体、事件、时间、地点和关系": "Extract subjects, events, time, locations, and relationships from announcements, news, sentiment, contracts, and business documents.",
    "将事件与实体沉淀为知识图谱，并保留原文证据、来源时间和置信度": "Build a knowledge graph from events and entities while preserving source evidence, source time, and confidence.",
    "通过图谱关系识别异常关联、风险传导路径和关键节点": "Use graph relationships to identify abnormal links, risk propagation paths, and key nodes.",
    "生成风险等级、核心证据、不确定点和下一步业务动作": "Generate risk levels, core evidence, uncertainty points, and next business actions.",
    "高风险结论进入人工复核，避免把相关性直接包装成确定性因果": "Send high-risk conclusions to human review to avoid presenting correlation as confirmed causality.",
    "NLP 抽取层": "NLP extraction layer",
    "把非结构化材料转成实体、关系、事件和属性，并保留原文证据。": "Convert unstructured material into entities, relationships, events, and attributes while preserving source evidence.",
    "图谱推理层": "Graph reasoning layer",
    "基于主体关系、时间线和事件链路识别风险传导、异常关联和关键节点。": "Identify risk propagation, abnormal links, and key nodes from entity relationships, timelines, and event chains.",
    "决策 Agent 层": "Decision Agent layer",
    "由风险识别、证据核验、反例搜索和报告生成多个子任务组成，输出可复核结论。": "Combine risk detection, evidence verification, counterexample search, and report generation into reviewable conclusions.",
    "知识图谱类 AI 产品如果只停留在画布展示，容易变成前端可视化作品。把它升级为决策 Agent 后，才能讲清楚 ToB 场景中更重要的可信、可追溯、可审计和人机协同。": "If a knowledge-graph AI product stops at canvas visualization, it risks becoming only a front-end showcase. Upgrading it into a decision agent makes the ToB value clearer: trust, traceability, auditability, and human-AI collaboration.",
    "本 Demo 使用模拟行业文本和风险事件展示产品流程，不包含真实企业敏感数据。": "This demo uses simulated industry text and risk events. It contains no real sensitive enterprise data.",
    ...
    "已接入腾讯云后端大模型": "Tencent Cloud backend LLM connected",
    "打开腾讯云在线 Demo": "Open Tencent Cloud live demo",
    "企业 RAG 智能体运营台 · 在线 Demo": "Enterprise RAG Agent Ops Console · Live Demo",
    "行业知识图谱决策 Agent · 在线 Demo": "Industry Knowledge Graph Decision Agent · Live Demo",
    "AI 内容增长中台 · 在线 Demo": "AI Content Growth Platform · Live Demo",
    "已部署到腾讯云，包含知识接入、答案溯源、权限治理、评测闭环与真实后端大模型分析。 为避免 GitHub Pages 的 HTTPS 页面拦截 HTTP 服务，请在新窗口打开体验。": "Hosted on Tencent Cloud with knowledge ingestion, answer traceability, permission governance, evaluation loops, and live backend LLM analysis. Open it in a new window because GitHub Pages cannot embed an HTTP service inside an HTTPS page.",
    "已部署到腾讯云，包含事件抽取、图谱推理、风险研判、证据链报告与真实后端大模型分析。 为避免 GitHub Pages 的 HTTPS 页面拦截 HTTP 服务，请在新窗口打开体验。": "Hosted on Tencent Cloud with event extraction, graph reasoning, risk judgment, evidence-chain reporting, and live backend LLM analysis. Open it in a new window because GitHub Pages cannot embed an HTTP service inside an HTTPS page.",
    "已部署到腾讯云，包含热点机会、达人匹配、脚本方向、投放复盘、舆情安全与真实后端大模型分析。 为避免 GitHub Pages 的 HTTPS 页面拦截 HTTP 服务，请在新窗口打开体验。": "Hosted on Tencent Cloud with trend opportunities, creator matching, script direction, campaign review, sentiment safety, and live backend LLM analysis. Open it in a new window because GitHub Pages cannot embed an HTTP service inside an HTTPS page.",
    "在线 Demo": "Live demo"
    ,"✅ 特征": "✅ Feature"
    ,"🎭 情感": "🎭 Emotion"
    ,"👤 转": "👤 Human"
    ...
    ,"AI 前台的竞争点不只是“回答得像不像人”，而是能否把每一次电话变成可衡量、可追回、可迭代的业务资产。对企业通信平台来说，最重要的是把 AI 能力接入真实通信链路和客户增长链路。": "The key differentiator for an AI receptionist is not only whether it sounds human, but whether every call becomes measurable, recoverable, and improvable business value. For enterprise communications platforms, the priority is connecting AI capabilities to real communication and customer-growth workflows."
    ,"本 Demo 使用公开业务信息与模拟数据进行产品方案表达，不代表任何公司的内部数据或已上线功能。": "This demo uses public business context and simulated data for product concept communication. It does not represent any company's internal data or launched functionality."
    ,"核心指标": "Key metrics"
  ...
  function rememberContent() {
    ...
    document.querySelectorAll("img[src]").forEach((image) => {
      ...
      if (/assets\/generated\/project-(01|02|03|04|07|08|10|11|12|13|14)-demo\.png(?:\?|$)/.test(src)) {
